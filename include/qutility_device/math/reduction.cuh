...
namespace qutility
{
    namespace device
    {
        namespace math
        {
            ...
            __global__ void array_mul_total_device_coef(IntT single_size, ValT *dst, const ValT *src1, const ValT *src2, const ValT *coef, ValT *working, ValT factor)
            {
                QUTILITY_DEVICE_SYNC_GRID_PREPARE;
